...
class GameQueue:
    ...
    @staticmethod
    def create_room(players: list, teams: dict = None) -> str:
        '''Creates a GameRoom and returns game key'''
        if len(players) < 2:
