...
export const GuessResultCard = ({ response }: GuessResultCardProps) => {
    ...
    return (
        <div className="absolute bottom-3 left-1/2 -translate-x-1/2 z-50 flex flex-col items-center w-[calc(100%-1.5rem)] max-w-[220px] p-3 rounded-2xl bg-glass-bg backdrop-blur-md border border-glass-border shadow-xl animate-fade-in text-dark select-none transition-transform duration-500 ease-out hover:scale-[1.6] origin-bottom">
